...
Here are examples of the interactive HTML reports generated by the tool:

### Performance Overview Dashboard
![Sample Report 1](reports/sample_report_1.png)

### Detailed Performance Analytics
![Sample Report 2](reports/sample_report_2.png)

### Trade Analysis and Metrics
![Sample Report 3](reports/sample_report_3.png)

The reports feature a modern dark theme with interactive charts that allow you to:
- Zoom and pan through performance data
